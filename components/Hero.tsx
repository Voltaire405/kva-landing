export default function Hero() {
  return (
    <section className="bg-gradient-to-br from-primary to-primary-light text-white pt-24 sm:pt-28 md:pt-32 lg:pt-36 xl:pt-[150px] pb-12 sm:pb-16 md:pb-20 lg:pb-[100px] text-center">
